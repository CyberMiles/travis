...
func initTravisDb() error {
	...
	if err != nil {
		...
		create table punish_history(pub_key text not null, slashing_ratio integer default 0, slashing text not null, reason text not null default '', created_at text not null);
