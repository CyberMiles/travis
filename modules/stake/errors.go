...
var (
	...
	errNoBondingAcct      = fmt.Errorf("No bond account for this (address, simpleValidator) pair")
	...
	errNoDelegatorForAddress           = fmt.Errorf("Delegator does not contain simpleValidator bond")
	errInsufficientFunds               = fmt.Errorf("Insufficient bond shares")
	errBadRemoveValidator              = fmt.Errorf("Error removing simpleValidator")
